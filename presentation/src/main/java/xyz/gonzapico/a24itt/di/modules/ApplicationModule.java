...
import xyz.gonzapico.a24itt.Base24Application;
import xyz.gonzapico.a24itt.UIThread;
...
@Module public class ApplicationModule {
  private final Base24Application application;

  public ApplicationModule(Base24Application application) {
  ...
  @Provides @Singleton MoviesDomainRepository provideMoviesRepository(
